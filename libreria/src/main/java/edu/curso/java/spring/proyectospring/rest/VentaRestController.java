...
import edu.curso.java.spring.proyectospring.rest.dto.VentaDTO;
...
public class VentaRestController {
	...
	private static Logger log = LoggerFactory.getLogger(VentaRestController.class);

	@GetMapping("/ventas")
	public List<VentaDTO> obtenerTodosLasVentas() {
		List<Venta> ventas = ventaService.buscarTodasLasVentas();
		List<VentaDTO> ventaDTO = new ArrayList<VentaDTO>();
		for (Venta venta : ventas) {
			ventaDTO.add(new VentaDTO(venta));
		}
